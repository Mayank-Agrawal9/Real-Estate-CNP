# Generated by Django 5.1.4 on 2025-03-27 01:19
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('p2pmb', '0019_commission_level_type'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reward_type', models.CharField(choices=[('leader', 'leader'), ('self', 'self')], default='leader', max_length=20)),
                ('turnover_amount', models.DecimalField(decimal_places=2, default=0.0, max_digits=12)),
